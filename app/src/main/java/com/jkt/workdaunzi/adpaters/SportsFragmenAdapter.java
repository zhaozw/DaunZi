...
public class SportsFragmenAdapter extends RecyclerView.Adapter {
    public List<SportsModel.ItemBean> mItemBeanList;
    ...
    public SportsFragmenAdapter(List<SportsModel.ItemBean> itemBeanList, Context context) {
    ...
    public class DocViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(SportsModel.ItemBean itemBean) {
