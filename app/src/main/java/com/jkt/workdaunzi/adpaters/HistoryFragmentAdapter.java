...
public class HistoryFragmentAdapter extends RecyclerView.Adapter {
    public List<HistoryModel.ItemBean> mItemBeanList;
    ...
    public HistoryFragmentAdapter(List<HistoryModel.ItemBean> itemBeanList, Context context) {
    ...
    public class DocViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(HistoryModel.ItemBean itemBean) {
