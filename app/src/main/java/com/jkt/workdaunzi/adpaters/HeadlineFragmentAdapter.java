...
public class HeadlineFragmentAdapter extends RecyclerView.Adapter {
    public List<HeadlineModel.ItemBean> mItemBeanList;
    ...
    public HeadlineFragmentAdapter(List<HeadlineModel.ItemBean> itemBeanList, Context context) {
    ...
    public class DocViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(HeadlineModel.ItemBean itemBean) {
