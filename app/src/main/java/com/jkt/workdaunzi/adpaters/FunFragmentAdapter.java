...
public class FunFragmentAdapter extends RecyclerView.Adapter {
    public List<FunModel.ItemBean> mItemBeanList;
    ...
    public FunFragmentAdapter(List<FunModel.ItemBean> itemBeanList, Context context) {
    ...
    public class DocViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(FunModel.ItemBean itemBean) {
