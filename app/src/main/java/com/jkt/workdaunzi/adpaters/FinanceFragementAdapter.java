...
public class FinanceFragementAdapter extends RecyclerView.Adapter {
    public List<FinanceModel.ItemBean> mItemBeanList;
    ...
    public FinanceFragementAdapter(List<FinanceModel.ItemBean> itemBeanList, Context context) {
    ...
    public class DocViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(FinanceModel.ItemBean itemBean) {
