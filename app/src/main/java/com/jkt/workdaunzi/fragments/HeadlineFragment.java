...
import com.jkt.workdaunzi.adpaters.HeadlineFragmentAdapter;
 ...
 */
public class HeadlineFragment extends Fragment implements INetView, IJsonView, SwipeRefreshLayout.OnRefreshListener, MyScrollView.IScrollListener, View.OnClickListener {
    ...
    private List<HeadlineModel.ItemBean> mItemBeanList;
    ...
    private void initRecyclerViewAdapter() {
        ...
        mAdapter = new HeadlineFragmentAdapter(mItemBeanList, getContext());
    ...
    private void initNet() {
        ...
        String url = "http://api.iclient.ifeng.com/ClientNews?id=SYLB10,SYDT10&page=1&gv=4.4.1&av=4.4.1&uid=865479029646411&deviceid=865479029646411&proid=ifengnews&os=android_22&df=androidphone&vt=5&screen=1152x1920&publishid=2024";
        new NetPresenter(this, "HeadlineModel").getNetByteByOkHttp3(url,
                "GET", null, null, null);
    }

    private void initViews(View inflate) {
        mRecyclerView = ((RecyclerView) inflate.findViewById(R.id.fragment_headline_recyclerView));
        mSwipeRefreshLayout = ((SwipeRefreshLayout) inflate.findViewById(R.id.fragment_headline_refreshLayout));
        mFrameLayout = ((FrameLayout) inflate.findViewById(R.id.fragment_headline_FrameLayout));
        mProgressBar = ((ProgressBar) inflate.findViewById(R.id.fragment_headline_progressBar));
        mTextView = ((TextView) inflate.findViewById(R.id.fragment_headline_textView));
        mButton = ((Button) inflate.findViewById(R.id.fragment_headline_button));
        mMyScrollView = ((MyScrollView) inflate.findViewById(R.id.fragment_headline_myScrollView));
        mFinishTextView = ((TextView) inflate.findViewById(R.id.fragment_headline_finishTextView));
    }
    ...
    public void getNetSuccess(byte[] bytes, String mark) {
        ...
        switch (mark) {
            case "HeadlineModel":
                ...
                try {
                    new JsonPresenter(this, HeadlineModel.class, "HeadlineModel")
    ...
    private void initRecyclerViewData(Object object) {
        if (object != null && object instanceof HeadlineModel) {
            HeadlineModel headlineModel = (HeadlineModel) object;
            List<HeadlineModel.ItemBean> itemBeanList = headlineModel.getItem();

            if (itemBeanList != null && itemBeanList.size() > 0) {
                if (mPage == 1) {
                    mAllPage = headlineModel.getTotalPage();
    ...
    private void initCacheData() {
        ...
        if (filesDir != null) {
            mFile = new File(filesDir, "HeadlineModel");
    ...
    private void initMoreNet() {
        ...
        mGetMoreing = true;
        mPage++;
        String url = "http://api.iclient.ifeng.com/ClientNews?id=SYLB10,SYDT10&page=" +
                mPage +
